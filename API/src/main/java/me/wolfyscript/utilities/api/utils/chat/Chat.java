...
public class Chat {
    ...
    public void sendConsoleMessage(String message, String... replacements) {
        ...
        Bukkit.getServer().getConsoleSender().sendMessage(me.wolfyscript.utilities.api.utils.chat.ChatColor.convert(message));
    }
    ...
    public void sendPlayerMessage(Player player, String message) {
        if (player != null) {
            player.sendMessage(me.wolfyscript.utilities.api.utils.chat.ChatColor.convert(CHAT_PREFIX + languageAPI.replaceKeys(message)));
        }
    }
    ...
    public void sendPlayerMessage(Player player, String message, String[]... replacements) {
        ...
        player.sendMessage(me.wolfyscript.utilities.api.utils.chat.ChatColor.convert(message));
    }
        ...
        for (int i = 1; i < textComponents.length; i++) {
            ...
            for (ChatEvent<?, ?> chatEvent : data.getChatEvents()) {
                if (chatEvent instanceof HoverEvent) {
                    ...
                    component.setClickEvent(new net.md_5.bungee.api.chat.ClickEvent(((me.wolfyscript.utilities.api.utils.chat.ClickEvent) chatEvent).getAction(), ((me.wolfyscript.utilities.api.utils.chat.ClickEvent) chatEvent).getValue()));
                }
            }
