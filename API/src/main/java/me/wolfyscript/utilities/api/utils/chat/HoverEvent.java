...
public class HoverEvent implements ChatEvent<net.md_5.bungee.api.chat.HoverEvent.Action, BaseComponent[]> {
    ...
    public HoverEvent(ItemStack itemStack) {
        this(net.md_5.bungee.api.chat.HoverEvent.Action.SHOW_ITEM, new ComponentBuilder(WolfyUtilities.getAPI(WolfyUtilities.getWUPlugin()).getItemUtils().convertItemStackToJson(itemStack)).create());
    }
