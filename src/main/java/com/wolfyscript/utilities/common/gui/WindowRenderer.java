...
public interface WindowRenderer extends Renderer {
    ...
    interface Builder extends Renderer.Builder<WindowRenderer> {
         ...
         */
        <B extends ComponentBuilder<? extends Component, Component>> Builder ifThenRender(SerializableSupplier<Boolean> condition, String id, Class<B> builderType, SerializableConsumer<B> builderConsumer);

        <BV extends ComponentBuilder<? extends Component, Component>, BI extends ComponentBuilder<? extends Component, Component>> Builder ifThenRenderOr(SerializableSupplier<Boolean> condition, Class<BV> builderValidType, Consumer<BV> builderValidConsumer, Class<BI> builderInvalidType, SerializableConsumer<BI> builderInvalidConsumer);


        <B extends ComponentBuilder<? extends Component, Component>> Builder position(int slot, String id, Class<B> builderType, SerializableConsumer<B> builderConsumer);
