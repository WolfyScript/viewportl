...
public class Position {
    ...
    public static class ValueDeserializer extends com.wolfyscript.utilities.json.ValueDeserializer<Position> {
    ...
    public static class ValueSerializer extends com.wolfyscript.utilities.json.ValueSerializer<Position> {
