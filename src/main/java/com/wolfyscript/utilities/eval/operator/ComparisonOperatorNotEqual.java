...
@KeyedStaticId(key = "not_equal")
public class ComparisonOperatorNotEqual<V extends Comparable<V>> extends ComparisonOperator<V> {

    @JsonCreator
    protected ComparisonOperatorNotEqual(@JacksonInject WolfyUtils wolfyUtils, @JsonProperty("this") ValueProvider<V> thisValue, @JsonProperty("that") ValueProvider<V> thatValue) {
