...
@KeyedStaticId(key = "greater")
public class ComparisonOperatorGreater<V extends Comparable<V>> extends ComparisonOperator<V> {

    @JsonCreator
    protected ComparisonOperatorGreater(@JacksonInject WolfyUtils wolfyUtils, @JsonProperty("this") ValueProvider<V> thisValue, @JsonProperty("that") ValueProvider<V> thatValue) {
