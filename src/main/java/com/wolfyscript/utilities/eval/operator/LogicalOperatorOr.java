...
public class LogicalOperatorOr extends LogicalOperator {
    ...
    @JsonCreator
    public LogicalOperatorOr(@JacksonInject WolfyUtils wolfyUtils, @JsonProperty("this") BoolOperator thisValue, @JsonProperty("that") BoolOperator thatValue) {
