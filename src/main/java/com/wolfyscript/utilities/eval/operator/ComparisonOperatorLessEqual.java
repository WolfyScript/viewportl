...
@KeyedStaticId(key = "less_equal")
public class ComparisonOperatorLessEqual<V extends Comparable<V>> extends ComparisonOperator<V> {

    @JsonCreator
    protected ComparisonOperatorLessEqual(@JacksonInject WolfyUtils wolfyUtils, @JsonProperty("this") ValueProvider<V> thisValue, @JsonProperty("that") ValueProvider<V> thatValue) {
