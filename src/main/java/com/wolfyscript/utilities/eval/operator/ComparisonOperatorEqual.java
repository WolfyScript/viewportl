...
@KeyedStaticId(key = "equal")
public class ComparisonOperatorEqual<V extends Comparable<V>> extends ComparisonOperator<V> {

    @JsonCreator
    protected ComparisonOperatorEqual(@JacksonInject WolfyUtils wolfyUtils, @JsonProperty("this") ValueProvider<V> thisValue, @JsonProperty("that") ValueProvider<V> thatValue) {
