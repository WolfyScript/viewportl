...
import me.wolfyscript.utilities.org.mozilla.javascript.tools.shell.Global;
...
public class Main {
     ...
     * {@link me.wolfyscript.utilities.org.mozilla.javascript.tools.shell.Main} shell session.
     */
    public static void main(String[] args) {
        ...
        Global global = me.wolfyscript.utilities.org.mozilla.javascript.tools.shell.Main.getGlobal();
        global.setIn(main.getIn());
        global.setOut(main.getOut());
        global.setErr(main.getErr());

        main.attachTo(
                me.wolfyscript.utilities.org.mozilla.javascript.tools.shell.Main.shellContextFactory);
        ...
        me.wolfyscript.utilities.org.mozilla.javascript.tools.shell.Main.exec(args);
    }
