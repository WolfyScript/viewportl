...
import me.wolfyscript.utilities.org.mozilla.classfile.ClassFileWriter.ClassFileFormatException;
import me.wolfyscript.utilities.org.mozilla.javascript.ast.AstRoot;
...
import me.wolfyscript.utilities.org.mozilla.javascript.debug.Debugger;
...
public class Context {
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
            "me.wolfyscript.utilities.org.mozilla.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
            "me.wolfyscript.utilities.org.mozilla.javascript.Interpreter");
    ...
    /**
     * @see ContextFactory#addListener(me.wolfyscript.utilities.org.mozilla.javascript.ContextFactory.Listener)
    ...
    public static void addContextListener(ContextListener listener) {
        ...
        String DBG = "me.wolfyscript.utilities.org.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                    "me.wolfyscript.utilities.org.mozilla.javascript.ContextFactory");
    ...
    /**
     * @see ContextFactory#removeListener(me.wolfyscript.utilities.org.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     * @deprecated
     */
    @Deprecated
     ...
     * @see me.wolfyscript.utilities.org.mozilla.javascript.ErrorReporter
     */
     ...
     * @see me.wolfyscript.utilities.org.mozilla.javascript.SecurityController
     */
    ...
    public Object resumeContinuation(Object continuation,
        ...
        return Interpreter.restartContinuation(
                (me.wolfyscript.utilities.org.mozilla.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @throws IOException if an IOException was generated by the Reader
     * @see me.wolfyscript.utilities.org.mozilla.javascript.Script
     */
    ...
    RegExpProxy getRegExpProxy() {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                    "me.wolfyscript.utilities.org.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
