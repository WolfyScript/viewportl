...
public class NativeJavaObject
    ...
    static {
        ...
        Class<?> cl = Kit.classOrNull("me.wolfyscript.utilities.org.mozilla.javascript.JavaAdapter");
        if (cl != null) {
            try {
     ...
     *
     * @see me.wolfyscript.utilities.org.mozilla.javascript.Context#jsToJava(Object, Class)
