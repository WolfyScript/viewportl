...
public interface ButtonPrepareRender {
     ...
     * <br/>
     * For example it can be used for setting items into cache for something like item input see {@link me.wolfyscript.utilities.api.inventory.button.buttons.ItemInputButton}
     * <br/>
     * .
     *
