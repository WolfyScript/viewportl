...
package me.wolfyscript.utilities.libraries.org.mozilla.javascript.tools.debugger;

import me.wolfyscript.utilities.libraries.org.mozilla.javascript.Kit;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.SecurityUtilities;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.tools.debugger.treetable.JTreeTable;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.tools.debugger.treetable.TreeTableModel;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.tools.debugger.treetable.TreeTableModelAdapter;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.tools.shell.ConsoleTextArea;
...
public class SwingGui extends JFrame implements GuiCallback {
     ...
     * {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context}.
     */
...
class EvalWindow extends JInternalFrame implements ActionListener {
     ...
     */
    private final EvalTextArea evalTextArea;
...
class FileHeader extends JPanel implements MouseListener {
     ...
     */
    private final FileWindow fileWindow;
...
class ContextWindow extends JPanel implements ActionListener {
     ...
     */
    private final MyTreeTable thisTable;
    /**
     * The table showing the stack local variables.
     */
    private final MyTreeTable localsTable;
    /**
     ...
     */
    private final EvalTextArea cmdLine;
    /**
...
class Menubar extends JMenuBar implements ActionListener {
     ...
     */
    private final JCheckBoxMenuItem breakOnExceptions;

    /**
     * The "Break on enter" menu item.
     */
    private final JCheckBoxMenuItem breakOnEnter;

    /**
     * The "Break on return" menu item.
     */
    private final JCheckBoxMenuItem breakOnReturn;
