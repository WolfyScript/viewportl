...
import me.wolfyscript.utilities.libraries.org.mozilla.classfile.ClassFileWriter;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.*;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.ast.FunctionNode;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.ast.Jump;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.ast.Name;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.ast.ScriptNode;

import java.lang.reflect.Constructor;
import java.util.*;

import static me.wolfyscript.utilities.libraries.org.mozilla.classfile.ClassFileWriter.*;
...
public class Codegen implements Evaluator {
    static final String DEFAULT_MAIN_METHOD_CLASS
            = "me.wolfyscript.utilities.libraries.org.mozilla.javascript.optimizer.OptRuntime";
    static final String ID_FIELD_NAME = "_id";
    static final String REGEXP_INIT_METHOD_NAME = "_reInit";
    static final String REGEXP_INIT_METHOD_SIGNATURE
            = "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;)V";
    static final String FUNCTION_INIT_SIGNATURE
            = "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
            + ")V";
    static final String FUNCTION_CONSTRUCTOR_SIGNATURE
            = "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;I)V";
    private static final String SUPER_CLASS_NAME
            = "me.wolfyscript.utilities.libraries.org.mozilla.javascript.NativeFunction";
    ...
    static void pushUndefined(ClassFileWriter cfw) {
        cfw.add(ByteCode.GETSTATIC, "me/wolfyscript/utilities/libraries/org/mozilla/javascript/Undefined",
    ...
    public Object compile(CompilerEnvirons compilerEnv,
        ...
        String mainClassName = "me.wolfyscript.utilities.libraries.org.mozilla.javascript.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource) {
        ...
        if (hasScript) {
            cfw.addInterface("me/wolfyscript/utilities/libraries/org/mozilla/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                "me/wolfyscript/utilities/libraries/org/mozilla/javascript/BaseFunction",
                "createObject",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "me/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "me/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw, boolean isStrictMode) {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                "me/wolfyscript/utilities/libraries/org/mozilla/javascript/ScriptRuntime",
                "hasTopCall",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                        + ")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                "me/wolfyscript/utilities/libraries/org/mozilla/javascript/ScriptRuntime",
                "doTopCall",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Callable;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                mainMethodClass,
                "main",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Script;[Ljava/lang/String;)V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                ...
                "checkRegExpProxy",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                        + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/RegExpProxy;");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                        "me/wolfyscript/utilities/libraries/org/mozilla/javascript/RegExpProxy",
                        "compileRegExp",
                        "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
    ...
    String getBodyMethodSignature(ScriptNode n) {
        ...
        sb.append("Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
...
class BodyCodegen {
    ...
    private void generateGenerator() {
        ...
        if (fnCurrent != null) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                    "me/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable",
                    "getParentScope",
                    "()Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/NativeFunction;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
                        + "Z"
                        + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;");
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/NativeFunction;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;II"
                        + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;");
    ...
    private void generateThrowJavaScriptException() {
        cfw.add(ByteCode.NEW,
                "me/wolfyscript/utilities/libraries/org/mozilla/javascript/JavaScriptException");
            ...
            case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                        ...
                        "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Callable;"
                                ...
                                + "[Ljava/lang/Object;"
                                + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                                + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Ref;");
                break;
        ...
        if (functionType == FunctionNode.ARROW_FUNCTION) {
            ...
            addOptRuntimeInvoke("bindThis",
                    "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/NativeFunction;"
                            ...
                            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                            + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Function;");
        }
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
                        + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;",
    ...
    private void visitSpecialCall(Node node, int type, int specialType,
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                    + "Ljava/lang/Object;"
                    + "[Ljava/lang/Object;"
                    + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                    + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child) {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Callable;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                        + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                        + ")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                    "me/wolfyscript/utilities/libraries/org/mozilla/javascript/Callable",
                    "call",
                    "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Context;"
                            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
    ...
    private String exceptionTypeToName(int exceptionType) {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "me/wolfyscript/utilities/libraries/org/mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "me/wolfyscript/utilities/libraries/org/mozilla/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "me/wolfyscript/utilities/libraries/org/mozilla/javascript/EcmaError";
