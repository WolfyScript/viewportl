...
public final class JavaAdapter implements IdFunctionCall {
    ...
    public static byte[] createAdapterCode(ObjToIntMap functionNames,
        ...
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                superClass.getName(),
                "<adapter>");
        cfw.addField("factory", "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/ContextFactory;",
                (short) (ClassFileWriter.ACC_PUBLIC |
                        ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;",
                (short) (ClassFileWriter.ACC_PUBLIC |
                        ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;",
                (short) (ClassFileWriter.ACC_PUBLIC |
                        ClassFileWriter.ACC_FINAL));
    ...
    private static void generateCtor(ClassFileWriter cfw, String adapterName,
        ...
        if (parameters.length == 0) {
            cfw.startMethod("<init>",
                    "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/ContextFactory;)V",
            ...
            StringBuilder sig = new StringBuilder(
                    "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;"
                            + "Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/ContextFactory;");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                "me/wolfyscript/utilities/libraries/org/mozilla/javascript/JavaAdapter",
    ...
    private static void generateEmptyCtor(ClassFileWriter cfw,
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                "me/wolfyscript/utilities/libraries/org/mozilla/javascript/JavaAdapter",
                "runScript",
                "(Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Script;"
                        + ")Lme/wolfyscript/utilities/libraries/org/mozilla/javascript/Scriptable;");
    ...
    static void generateReturnResult(ClassFileWriter cfw, Class<?> retType,
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                    "me/wolfyscript/utilities/libraries/org/mozilla/javascript/Context",
