...
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.v8dtoa.DoubleConversion;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.v8dtoa.FastDtoa;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.xml.XMLLib;
import me.wolfyscript.utilities.libraries.org.mozilla.javascript.xml.XMLObject;
...
public class ScriptRuntime {
    ...
    public final static Class<?>
            ContextClass
            = Kit.classOrNull("me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context"),
            ContextFactoryClass
                    = Kit.classOrNull("me.wolfyscript.utilities.libraries.org.mozilla.javascript.ContextFactory"),
            FunctionClass
                    = Kit.classOrNull("me.wolfyscript.utilities.libraries.org.mozilla.javascript.Function"),
            ScriptableObjectClass
                    = Kit.classOrNull("me.wolfyscript.utilities.libraries.org.mozilla.javascript.ScriptableObject");
    ...
    public static ScriptableObject initSafeStandardObjects(Context cx,
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "me.wolfyscript.utilities.libraries.org.mozilla.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "me.wolfyscript.utilities.libraries.org.mozilla.javascript.NativeContinuation", sealed, true);
        ...
        if (((cx.getLanguageVersion() >= Context.VERSION_1_8) &&
            ...
            new LazilyLoadedCtor(scope, "ArrayBuffer",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeArrayBuffer",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Int8Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeInt8Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Uint8Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeUint8Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Uint8ClampedArray",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeUint8ClampedArray",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Int16Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeInt16Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Uint16Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeUint16Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Int32Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeInt32Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Uint32Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeUint32Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Float32Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeFloat32Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "Float64Array",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeFloat64Array",
                    sealed, true);
            new LazilyLoadedCtor(scope, "DataView",
                    "me.wolfyscript.utilities.libraries.org.mozilla.javascript.typedarrays.NativeDataView",
                    sealed, true);
        }
    ...
    public static ScriptableObject initStandardObjects(Context cx,
        ...
        new LazilyLoadedCtor(s, "Packages",
                "me.wolfyscript.utilities.libraries.org.mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(s, "getClass",
                "me.wolfyscript.utilities.libraries.org.mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(s, "JavaAdapter",
                "me.wolfyscript.utilities.libraries.org.mozilla.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(s, "JavaImporter",
                "me.wolfyscript.utilities.libraries.org.mozilla.javascript.ImporterTopLevel", sealed, true);
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "me.wolfyscript.utilities.libraries.org.mozilla.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        ...
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                    = "me.wolfyscript.utilities.libraries.org.mozilla.javascript.resources.Messages";
