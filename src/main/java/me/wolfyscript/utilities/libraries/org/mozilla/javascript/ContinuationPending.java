...
/**
 * Exception thrown by
 * {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 *
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link me.wolfyscript.utilities.libraries.org.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
     *
