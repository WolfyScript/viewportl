...
public interface ButtonPostAction {
     ...
     * It is called right before the prepare render method, but only if the button was executed!
     * <br/>
     ...
     * @param event      The previous event of the click that caused the update
     */
    void process(GuiHandler<?> guiHandler, Player player, Inventory inventory, ItemStack itemStack, int slot, InventoryClickEvent event);
}
