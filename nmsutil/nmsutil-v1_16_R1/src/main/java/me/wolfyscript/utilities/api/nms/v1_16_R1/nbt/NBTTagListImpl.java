...
public class NBTTagListImpl extends NBTBaseImpl<net.minecraft.server.v1_16_R1.NBTTagList> implements NBTTagList {

    public static final NBTTagType<NBTTagList> TYPE = new NBTTagTypeImpl<>(NBTTagType.Type.LIST, nbtBase -> new NBTTagListImpl((net.minecraft.server.v1_16_R1.NBTTagList) nbtBase));

    NBTTagListImpl(net.minecraft.server.v1_16_R1.NBTTagList nbtBase) {
        super(nbtBase);
    }

    public static NBTTagList of() {
        return new NBTTagListImpl(new net.minecraft.server.v1_16_R1.NBTTagList());
    }
