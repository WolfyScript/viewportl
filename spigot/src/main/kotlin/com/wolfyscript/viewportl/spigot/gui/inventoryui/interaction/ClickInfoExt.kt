...
fun InventoryClickEvent.convert() : ClickInfo {
    ...
    return when (click) {
        ...
        org.bukkit.event.inventory.ClickType.CONTROL_DROP -> CommonClickInfoImpl.Drop.Full(rawSlot, cursorStack, slotStack)
        org.bukkit.event.inventory.ClickType.WINDOW_BORDER_LEFT -> CommonClickInfoImpl.Drop.Outside.Primary(rawSlot, cursorStack, slotStack)
        org.bukkit.event.inventory.ClickType.WINDOW_BORDER_RIGHT -> CommonClickInfoImpl.Drop.Outside.Secondary(rawSlot, cursorStack, slotStack)
        // Key clicks
        org.bukkit.event.inventory.ClickType.NUMBER_KEY -> CommonClickInfoImpl.NumberPress(rawSlot, hotbarButton, cursorStack, slotStack)
        // most common clicks
        ...
        // Shift
        org.bukkit.event.inventory.ClickType.SHIFT_LEFT -> CommonClickInfoImpl.Shift.Primary(rawSlot, cursorStack, slotStack)
        org.bukkit.event.inventory.ClickType.SHIFT_RIGHT -> CommonClickInfoImpl.Shift.Secondary(rawSlot, cursorStack, slotStack)
        // Creative
