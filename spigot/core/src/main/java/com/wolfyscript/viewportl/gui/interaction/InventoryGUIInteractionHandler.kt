...
class InventoryGUIInteractionHandler(private val runtime: ViewRuntimeImpl) : InteractionHandler {
    ...
    override fun onClick(details: ClickInteractionDetails) {
        details as com.wolfyscript.viewportl.gui.interaction.ClickInteractionDetailsImpl
        ...
        when (action) {
            ...
            InventoryAction.COLLECT_TO_CURSOR -> {
                ...
                if (details.valid) { // Only continue to collect items when main component allows it
                    ...
                    slotResult = null
                    details.callSlotValueUpdate(event.rawSlot, ItemStackImpl(null))
                    ...
                    if (cursor != null) {
                        ...
                        collectToCursor(cursor, event.view, { index, stack ->
                            ...
                            details.callSlotValueUpdate(rawSlot, ItemStackImpl(stack))
                        }
                    }
                    ...
                    if (clickedTopInv) {
                        ...
                        if (slotResult != null) {
                            moveToOtherInventory(
                                ...
                                { _, _ -> true }) { _, _ -> }
                            details.callSlotValueUpdate(event.rawSlot, ItemStackImpl(slotResult))
    ...
    private fun testMainClickTransaction(details: com.wolfyscript.viewportl.gui.interaction.ClickInteractionDetailsImpl) {
