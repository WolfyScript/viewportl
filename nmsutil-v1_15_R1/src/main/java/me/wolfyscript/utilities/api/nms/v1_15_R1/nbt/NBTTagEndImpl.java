...
public class NBTTagEndImpl extends NBTBaseImpl<net.minecraft.server.v1_15_R1.NBTTagEnd> implements NBTTagEnd {
    ...
    private NBTTagEndImpl() {
        super(net.minecraft.server.v1_15_R1.NBTTagEnd.b);
    }

    NBTTagEndImpl(net.minecraft.server.v1_15_R1.NBTTagEnd nbtBase) {
        super(net.minecraft.server.v1_15_R1.NBTTagEnd.b);
    }
