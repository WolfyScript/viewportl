...
class InventorySlotElementRenderer : ElementRenderer<StackInputSlot, SpongeInvUIRenderContext> {

    override fun key(): Key = Key.defaultKey("inventory/slot")

    override fun render(context: SpongeInvUIRenderContext, component: StackInputSlot) {
