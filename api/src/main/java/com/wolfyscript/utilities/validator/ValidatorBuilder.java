...
public interface ValidatorBuilder<T> {
     ...
     */
    static <T> InitStep<T, ?> object(NamespacedKey key) {
     ...
     */
    static <T> InitStep<Collection<T>, CollectionValidatorBuilder<T>> collection(NamespacedKey key) {
     ...
     * @return This builder instance for chaining
     */
    <C> ValidatorBuilder<T> object(Function<T, C> getter, Function<InitStep<C, ?>, ValidatorBuilder<C>> childBuilder);
     ...
     */
    <C> ValidatorBuilder<T> collection(Function<T, Collection<C>> getter, Function<InitStep<Collection<C>, CollectionValidatorBuilder<C>>, ValidatorBuilder<Collection<C>>> childBuilder);
